...
export const MovilidadMetropolitana: React.FC = () => {
      ...
      <div className="bg-white shadow-sm py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-3">
            <Map size={36} className="text-imdut-primary" />
            <div>
              <h1 className="text-3xl font-bold text-imdut-primary">Movilidad Metropolitana</h1>
              <p className="text-gray-600 mt-2 max-w-3xl">
                Visión integral para la zona metropolitana de Mérida y sus municipios conurbados. Explora el Plan Maestro 2030 y los datos clave de la región.
              </p>
            </div>
          </div>
        </div>
